...
def define_G(opt):
    ...
    use_ConvDownsampling = which_model.get('use_ConvDownsampling', False)
    down_first = which_model.get('down_first', False)
...
def define_grey(opt):
    ...
    Conv1x1Grey_learnable = which_model.get('Conv1x1Grey_learnable', True)
